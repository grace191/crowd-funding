...
public class LoginController {
	 ...
	 * ModelAndView createProject(Principal principal) {
	 * 
	 * ModelAndView model = new ModelAndView(); System.out.println("principle" +
	 * principal); if (principal != null) { model.setViewName("login"); }
	 * 
	 * return model;
	 * 
	 * }
