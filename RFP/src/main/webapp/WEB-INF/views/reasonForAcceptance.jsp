...
href="https://mobirise.com/bootstrap-template/mobirise-free-template.zip">DOWNLOAD</a></li></ul></div>-->
	...
	<section
		...
		<div id="dialog-box">
			<div class="dialog-content">
				...
				<a href="#" class="button" id="GoToRegister">OK</a>
			</div>
		</div>
		<div
	...
	<script>
			$(document).ready(function() {
				...
				$('#reasonForAccept').click(function() {
					var text = $("#feedback").val();
					$.ajax({
						type : "POST",
						url : "<c:url value='/accept/register/${projectId}/${contactId}'/>",
						data : {
							feedback : text
						}
				...
				$('#GoToRegister').click(function() {
					window.location.href="<c:url value='/register/${projectId}/${contactId}'/>";
					/* var text = $("#feedback").val();
					$.ajax({
						type : "POST",
