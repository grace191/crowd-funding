				...
				<div class="col-sm-12 col-md-12 col-lg-122" data-form-type="formoid">
					...
					<form:form action="${addAction}" modelAttribute="project"
						...
						<sec:authorize access="isAuthenticated()">
							<div class="form-group">
								<div id="result" class="col-sm-10 col-md-10 col-lg-10"
						...
						<c:if test="${!empty summary}">
							...
							<div class="form-group">
								...
								Summary:</label> -->
								<div class="col-md-10 col-sm-10">${project.summary }</div>
						...
						<sec:authorize access="isAuthenticated()">
							...
							<div class="form-group">
								<div class="col-md-10 col-sm-10">${project.description }</div>
							</div>
							...
							<div class="form-group">
								<div
									class="col-sm-10 col-lg-10 col-md-10 mbr-buttons mbr-buttons--right">
