...
<title>Participant Projects</title>
		...
		<div
			...
			<table id="table" class="table table-hover table-mc-light-blue">
				...
				<c:forEach items="${myprojects}" var="project">
								<tr>
									<td data-title="ID" style="display:none"><c:out value="${project.projectId }" /></td>
									<td data-title="ID"><a href="<c:url value='/user/offer/${project.projectId}'/>"><c:out
												value="${project.projectTitle}" /></a></td>
								<%-- 	<td><c:out value="${project.invitationStatus }" /></td> --%>
									<td data-title="ID">${project.offerStatus}</td>
									<td data-title="ID">${project.offerPrice}</td>
									<td></td>
								</tr>
							</c:forEach>
					...
					<%-- <c:forEach items="${myprojects}" var="project">
						<tr>
							...
							<td data-title="Link"><a
								href="<c:url value='/project/${project.id}'/>"><c:out
