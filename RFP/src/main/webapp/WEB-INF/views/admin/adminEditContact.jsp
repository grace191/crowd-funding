						...
						<sec:authorize access="hasRole('ROLE_ADMIN')">
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									<li><a href="<c:url value='/admin/CreateAccount'/>">New User</a></li>
									<c:url value="/admin/accounts" var="url" />
									<li class="active"><a href="${url}">All Users</a></li>
								</ul></li>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2">
							<c:url var="addContact" value="/admin/contact/edit/${user_id }" />
							<form:form method="post" modelAttribute="contact"
								...
								<div class="form-group" style="padding:20px 0">
									<div class="col-sm-2 col-md-offset-10" style="padding-left:40px">
										<button type="submit"
