										...
										<table class="table table-striped jambo_table bulk_action">
											<thead>
												<tr class="headings">
													...
													<th class="column-title">Invitation Status</th>
													<th class="column-title">Reason For Decline</th>
													<th class="column-title">Reason For Acceptance</th>
													<th class="column-title">Offer Status</th>
												...
												<c:forEach items="${invitations }" var="invitation">
													<tbody>
														<tr>
															...
															<td class="a-center " style="display: none">${invitation.projectId }</td>
															<td class="a-center ">${invitation.projectTitle}</td>
															<td class="a-center ">${invitation.firstName}</td>
															<td class="a-center ">${invitation.lastName }</td>
															<td class="a-center ">${invitation.contactEmail }</td>
															<td class="a-center ">${invitation.invitationStatus }</td>
															<td class="a-center ">${invitation.reasonForDecline }</td>
															<td class="a-center ">${invitation.reasonForAcceptance }</td>
															<td class="a-center ">${invitation.offerStatus }</td>
