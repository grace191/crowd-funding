					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2" data-form-type="formoid">
							...
							<c:url var="addInvitation"
								value="/admin/invitation/add/${projectId}/${userId }" />
 ...
 --%>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 mbr-buttons mbr-buttons--right">
												...
												<%-- <a href="<c:url value='/project/projects'/>"
												class="mbr-buttons__btn btn btn-lg btn-success">ADD</a> --%>
											</div>
											<div class="col-sm-6 mbr-buttons mbr-buttons--right">
												<a class="mbr-buttons__btn btn btn-lg btn-success"
													id="ViewContacts">VIEW ALL CONTACTS</a>
											</div>
								...
								<div class="form-group">
									...
									<div class="mbr-buttons mbr-buttons--right">
										...
										<input type="submit" id="invitation_submit" value="SEND"
				...
				.ready(
						function() {
													...
													if (firstname && lastname
														...
														$
																.ajax(
																		{
																			type : "POST",
																			url : "<c:url value='/admin/contact/new/${userId}'/>",
																			data : {
																				FirstName : firstname,
																				LastName : lastname,
																				Email : email
													...
													if (firstname && lastname
														...
														$
																.ajax(
																		{
																			type : "POST",
																			url : "<c:url value='/admin/contact/edit/${userId}'/>",
																			data : {
																				ContactId : contactId,
																				FirstName : firstname,
																				LastName : lastname,
							...
							function viewContacts() {
								$
										.get(
												"<c:url value='/admin/viewContacts/${userId}'/>",
												function(data) {
	...
	<script type="text/javascript">
		...
		function editContact(id) {
			...
			$.get("<c:url value='/admin/delete/contact/"+id+"'/>", function(
					data) {
