...
<body class="nav-md">
	...
	<!-- gauge.js -->
	<script
		src="<c:url value='/resources/vendors/bernii/gauge.js/dist/gauge.min.js'/>"></script>
	<!-- bootstrap-progressbar -->
	<script
	...
	<script src="<c:url value='/resources/js/flot/date.js'/>"></script>
	<script src="<c:url value='/resources/js/flot/jquery.flot.spline.js'/>"></script>
	<script src="<c:url value='/resources/js/flot/curvedLines.js'/>"></script>
	<!-- jVectorMap -->
	<script
