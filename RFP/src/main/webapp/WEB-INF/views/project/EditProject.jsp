...
mbr-brand__img"
									src="<c:url value='/resources/assets/images/discover-mobile-350x350-53.png'/>"
									alt="Mobirise"></a></span> <span class="mbr-brand__name"><a
								class="mbr-brand__name text-white" href="#">RFP</a></span>
						</span>
					</div>
				...
				<div class="col-sm-12 col-md-12 col-lg-12">
					<div class="row">
						<div class="col-sm-12 col-md-12 col-lg-122"
							...
							<c:url var="editProject" value="/project/update/${project.id }" />
							<form:form action="${editProject}" modelAttribute="project"
													...
													<tbody>
														<c:forEach items="${filesList}" var="file">
															<tr>
																...
																<td class="col-md-3 mbr-buttons mbr-buttons--right"><a
 ...
 */												e.preventDefault();
												...
												$
														.ajax({
															url : '<c:url value="/project/edit/upload/attachment/${project.id }"/>',
															data : attachmentForm,
															dataType : 'text',
															processData : false,
															contentType : false,
		...
		function deleteImage() {
			...
			$
					.get(
							"<c:url value='/edit/delete/image/${project.id }' />",
							function(data) {
								$('#result').html('');
	...
	<script>
		...
		function uploadImage() {
			...
			$
					.ajax({
						url : '${pageContext.request.contextPath}/project/edit/upload/image/${project.id }',
						data : oMyForm,
						dataType : 'text',
						processData : false,
						contentType : false,
		...
		function deleteAttachment(id) {
			...
			$
					.get(
							"${pageContext.request.contextPath}/edit/delete/attachment/${project.id }/"
									+ id,
