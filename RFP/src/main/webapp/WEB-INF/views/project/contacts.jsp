					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2" data-form-type="formoid">
							<div
								...
								<h2 class="mbr-header__text">CONTACTS</h2>
							</div>
							<div>
 ...
 --%>
								...
								href="<c:url value='/edit/${contact.participant_email}'/>">Edit</a></td> --%>
												...
												<td>
													...
													data-toggle="collapse" data-target="#contact" type="button"
													onClick="editContact('${contact.contactId}')" value="Edit" />
												</td>
												<td><a class="mbr-buttons__btn btn btn-sm btn-danger"
					...
					.ready(
							function() {
														...
														if (firstname && lastname
															...
															$
																	.ajax(
																			{
																				type : "POST",
																				url : "<c:url value='/invitation/addContact'/>",
																				data : {
																					FirstName : firstname,
																					LastName : lastname,
																					Email : email
								...
								function viewContacts() {
									$
											.get(
													"<c:url value='/invitation/viewContacts'/>",
													function(data) {
				...
				.ready(
						function() {
							...
							function viewContacts() {
								$
										.get(
												"<c:url value='/project/invitation/viewContacts'/>",
												function(data) {
													if (data.contacts.length !== 0) {
														build(target,
																data.contacts);
 ...
 */														$("#target").empty();
		...
		function deleteContact(id) {
			console
					.log("<c:url value='/project/invitation/deleteContact/"+id+"'/>");
			/* 			alert(id);
